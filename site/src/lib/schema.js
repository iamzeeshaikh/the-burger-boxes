 ...
 * link that displayed (503) 461-4788 in the header and footer, and as visible
 ...
 *
 * The business uses (503) 461-4788, so every form of the other number is
...
const TEL_DISPLAY = '(503) 461-4788';
const TEL_HREF = 'tel:+15034614788';
...
export function normalizePhone(html) {
  ...
  // leading %20 inside the URI -- tel:(503) 461-4788 and friends, on the contact
